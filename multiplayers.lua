...
function scene:createScene( event )
   local group = self.view
    ...
    group:insert( option1)
    group:insert( option2)
...
function startGame()
  ...
  option1 = display.newText( "Player 1", leftX + screenW/8, textScore1.y + screenH/3.3, native.systemFont, 50 )
  option2 = display.newText( "Player 2", leftX + screenW/2 + screenW/18, textScore2.y + screenH/3.3 , native.systemFont, 50 )
...
function checkCollisions()
  ...
  if ball.y + screenW/150 < topLine.y + screenH/19 then
    if direction == 1 then
      direction = 4
    elseif direction == 2 then
      direction = 3
